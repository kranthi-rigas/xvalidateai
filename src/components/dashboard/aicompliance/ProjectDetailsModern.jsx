...
import "./ProjectDetailsModern.css";
  ...
  const getCategoryScores = () => {
    ...
    evaluation.forEach(section => {
      ...
      section.criteria?.forEach(criterion => {
        ...
        if (sectionName.includes("governance") || sectionName.includes("compliance")) {
          categories.governance.total += score;
          categories.governance.count++;
        } else if (sectionName.includes("instructional") || sectionName.includes("learning")) {
          categories.instructional.total += score;
          categories.instructional.count++;
        } else if (sectionName.includes("usability") || sectionName.includes("integration")) {
          categories.usability.total += score;
          categories.usability.count++;
        } else if (sectionName.includes("data") || sectionName.includes("reporting")) {
    ...
    return {
      governance: categories.governance.count > 0 ? (categories.governance.total / categories.governance.count).toFixed(1) : 0,
      instructional: categories.instructional.count > 0 ? (categories.instructional.total / categories.instructional.count).toFixed(1) : 0,
      usability: categories.usability.count > 0 ? (categories.usability.total / categories.usability.count).toFixed(1) : 0,
      data: categories.data.count > 0 ? (categories.data.total / categories.data.count).toFixed(1) : 0,
    };
  };
  ...
  return (
    <div className="project-details-modern">
      ...
      <div className="top-actions">
        <button onClick={() => onBack?.(false)} className="back-button glass-card">
      ...
      <div className="glass-card report-header animate-fade-in">
        <div className="header-top">
          <div>
            ...
            <p className="subtitle">Comprehensive compliance and quality evaluation</p>
          </div>
          ...
          <div className="tool-info">
            <div className="tool-header">
              ...
              <div>
                ...
                <p className="tool-vendor">by {project.developer || "Unknown"}</p>
              </div>
            </div>
            ...
            <div className="tool-details">
              <div className="detail-row">
                ...
                <span className="detail-value">{project.intended_users || "-"}</span>
              </div>
              <div className="detail-row">
                <span className="detail-label">Grade Level:</span>
                <span className="detail-value">{project.grade_level || "-"}</span>
              </div>
              <div className="detail-row">
              ...
              <div className="detail-row">
                ...
                <span className="detail-value secondary">{formatUser(project.requested_by)}</span>
              </div>
              {project.url && (
                <div className="detail-row">
            ...
            <div className="score-container glass-card">
              ...
              <Plot
                data={[{
                  ...
                  gauge: {
                    axis: { range: [null, 100], tickwidth: 0, showticklabels: false },
        ...
        {project.compliance_followed && project.compliance_followed.length > 0 && (
          <div className="certifications">
            <h4 className="certifications-title">Compliance Certifications</h4>
      ...
      <div className="glass-card executive-summary animate-fade-in" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="summary-grid-2x2">
          <div className="summary-card glass-card">
            ...
            <p className="summary-text">{project.allowed_usage || 'Not specified'}</p>
          </div>
          ...
          <div className="summary-card glass-card">
            ...
            <p className="summary-text">{project.restricted_usage || 'Not specified'}</p>
          </div>
      ...
      {project.assessment?.evaluation && project.assessment.evaluation.map((section, idx) => {
          const sectionScore = parseFloat(section.average_score) || 0;
          const sectionScoreClass = sectionScore >= 4.0 ? 'score-excellent' : sectionScore >= 3.5 ? 'score-warning' : 'score-poor';
          
          return (
            <div key={idx} className="glass-card detailed-section animate-fade-in" style={{ animationDelay: `${0.6 + idx * 0.1}s` }}>
            <div className="detailed-header">
              ...
              <div className="section-score-badge">
                ...
                <span className={`score-value ${sectionScoreClass}`}>{section.average_score}/5.0</span>
              </div>
            </div>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th style={{ width: '48%' }}>
                      <i className="fa-solid fa-file-lines"></i> Detailed Observation
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {section.evaluation?.map((item, cidx) => {
                    ...
                    const scoreClass = criterionScore >= 4.0 ? 'score-excellent' : criterionScore >= 3.5 ? 'score-warning' : 'score-poor';
                    const statusIcon = criterionScore >= 4.0 ? 'fa-circle-check' : criterionScore >= 3.5 ? 'fa-circle-exclamation' : 'fa-circle-xmark';
                    const statusText = criterionScore >= 4.0 ? 'Excellent' : criterionScore >= 3.5 ? 'Good' : 'Needs Improvement';
      ...
      {project.recommendation && (
        <div className="glass-card recommendations animate-fade-in" style={{ animationDelay: '0.8s' }}>
          ...
          <div className="recommendation-content">
            ...
            <div className="recommendation-box info">
              ...
              <div>
                ...
                <p>Schedule quarterly reviews of tool performance, privacy practices, and student outcomes. Reassess annually or upon major platform updates.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {isRequested && isAdmin && (
        ...
        <div className="glass-card report-footer">
          <p className="footer-text">This report was generated by XVALIDATEAI Compliance Assessment System</p>
          <p className="footer-subtext">For questions or concerns, contact compliance@xvalidateai.com</p>
        </div>
