                      ...
                      <div className="row x-gap-20 y-gap-20">
                        ...
                        <div className="col-auto">
                          ...
                          >
                            ...
                            >
                              <span className="js-dropdown-title">Show 8</span>
                              <i className="icon text-9 ml-40 icon-chevron-down"></i>
                            </div>
              ...
              <div className="pt-20 pb-30 px-30 rounded-16 bg-white -dark-bg-dark-1 shadow-4">
                ...
                <div className="">
                  ...
                  <div className="d-flex x-gap-30 item-center pt-20">
                    <img src="/assets/img/dashboard/badges/2.png" alt="badge" />
                    <img src="/assets/img/dashboard/badges/3.png" alt="badge" />
                    <img src="/assets/img/dashboard/badges/4.png" alt="badge" />
                  </div>
                </div>
              </div>
            </div>
                    ...
                    {activeUsers.map((elm, i) => (
                      <div key={i} className="col-12">
                        <div className="d-flex items-center">
                          ...
                          <div className="ml-10">
                            <h6 className="text-14 lh-11 fw-500">{elm.name}</h6>
                          </div>
                        </div>
                      </div>
                    ))}
