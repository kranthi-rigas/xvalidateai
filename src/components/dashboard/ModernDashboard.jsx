...
export default function ModernDashboard() {
  ...
  const initializeCharts = () => {
    ...
    window.Plotly.newPlot('chart-recommendation', recommendationData, recommendationLayout, {displayModeBar: false, responsive: true});
    ...
    window.Plotly.newPlot('chart-users', usersData, usersLayout, {displayModeBar: false, responsive: true});
    ...
    const complianceData = [{
      ...
      orientation: 'h',
      marker: {
        color: ['#10b981', '#10b981', '#10b981', '#3b82f6', '#10b981', '#10b981', '#3b82f6', '#10b981', '#10b981', '#3b82f6']
      }
    }];
    ...
    window.Plotly.newPlot('chart-compliance', complianceData, complianceLayout, {displayModeBar: false, responsive: true});
  };

  return (
    <div className="dashboard__content" style={{ padding: "32px", backgroundColor: "#FAFAFA" }}>
      {/* Stats Cards Row */}
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="dashboard-card p-6 flex flex-col justify-between">
          ...
          <div className="text-xs text-muted-foreground">Tools awaiting evaluation</div>
        </div>
      </section>

      {/* High Risk & Charts Row */}
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8" style={{ minHeight: "400px" }}>
        {/* High Risk Alert Box */}
                ...
                <tr className="bg-red-50/30">
                  <td>
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold text-destructive">facebook.com</div>
                  ...
                  <td className="text-xs text-muted-foreground">Data sharing, Tracking, No educational purpose</td>
                ...
                <tr>
                  <td>
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold text-amber-700">x.com</div>
                        <div className="text-xs text-muted-foreground">Social Media</div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="text-xs text-muted-foreground">User generated content, Unmoderated</td>
                  <td className="text-right">
                ...
                <tr>
                  <td>
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold text-destructive">tiktok.com</div>
                        <div className="text-xs text-muted-foreground">Social Media</div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="text-xs text-muted-foreground">Data privacy concerns, Addiction risks</td>
                  <td className="text-right">
                    <span className="status-badge status-danger">Block</span>
                  </td>
                </tr>
            ...
            <div className="grid grid-cols-2 gap-8 w-full">
              {[
                ...
                <div key={idx} className="flex flex-col items-center">
                  <div className="score-circle" style={{ "--score": item.score, "--primary": item.color }}>
                    <span className="score-value" style={{ color: item.color }}>
                      {item.score}%
                    </span>
                  </div>
                  <p className="mt-2 text-xs font-semibold text-muted-foreground text-center">{item.label}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
        ...
        {/* Main Table Column */}
        <div className="lg:col-span-8 dashboard-card flex flex-col overflow-hidden" style={{ height: "664px" }}>
                ...
                {[
                  ...
                  <tr key={idx}>
                    <td>
                      ...
                      <div className="text-xs text-muted-foreground">{tool.vendor}</div>
                    </td>
                    <td>
                      <span className={`px-2 py-0.5 rounded text-xs ${tool.categoryBg} ${tool.categoryText}`}>
                        {tool.category}
                      </span>
                    </td>
                    <td>
                    ...
                    <td>
                      <span className={`status-badge ${tool.recClass}`}>{tool.recommendation}</span>
                    </td>
                    <td className="text-xs max-w-[200px] truncate">{tool.usage}</td>
