...
export default function Menu({ allClasses, headerPosition }) {
  ...
  const isMockTest = pathname.includes("dshb-mocktest");
  ...
  return (
    ...
    >
      <div className="header-menu__content">
        ...
        <div className={`menu js-navList ${isMockTest ? "d-none" : ""}`}>
              ...
              <div className="mega xl:d-none">
                <div className="mega__menu">
                  <div className="row x-gap-40">
                    {/* Column 1 */}
                    <div className="col">
                      <h4 className="text-17 fw-500 mb-20">JEE Online Courses</h4>
                    ...
                    {/* Column 2 - NEET Online Courses */}
                    <div className="col">
                      <h4 className="text-17 fw-500 mb-20">NEET Online Courses</h4>
                      <ul className="mega__list">
                        {menuList[1].links[1].links.map((elm, i) => (
                          ...
                          >
                            <Link data-barba to={elm.href}>{elm.label}</Link>
                          </li>
                        ))}
                      </ul>
                    </div>
                  ...
                  {/* ✅ Move the banner below and align bottom-right */}
                  <div className="mega-banner bg-purple-1 mt-30 mr-30 ml-auto w-fit text-right p-30 rounded-2xl">
                    ...
                    <Link
                      to="#"
                      className="button -md -green-1 text-dark-1 fw-500 mt-20"
                    >
