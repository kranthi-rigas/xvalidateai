    ...
    links: [
      {
        ...
        links: [
          { href: "/courses-list-1", label: "VEERAM JEE Crash Course" },
          { href: "/courses-list-2", label: "JEE Raftaar Crash Course" },
          { href: "/courses-list-3", label: "Sigma JEE Crash Course" },
          { href: "/courses-list-4", label: "DHRUTI JEE Crash Course" },
          { href: "/courses-list-5", label: "GenZ 2.0 JEE Crash Course" },
          { href: "/courses-list-6", label: "ISI/CMI Last Mile : 2026" },
          { href: "/courses-list-7", label: "VIDIYAL XI → XII Batch for JEE 2027" },

          { href: "/courses-list-8", label: "SIGMA Express JEE" },
        ],
      },
      {
        ...
        links: [
          { href: "/courses/3", label: "Eklavya NEET 2026" },
          { href: "/courses-single-2/2", label: "NEET Crash Course 2026" },
          { href: "/courses-single-3/3", label: "NEET Foundation" },
          { href: "/courses-single-4/4", label: "Arjuna NEET + EAPCET 2026" },
          { href: "/courses-single-5/4", label: "DNA Express NEET 2026" },
          { href: "/courses-single-6/7", label: "Vetri NEET 2026" },
